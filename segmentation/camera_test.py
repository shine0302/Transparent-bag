...
parser.add_argument('scene', nargs='?', default="semantic_segmentation/test_0909.obj", help="Path to the scene.obj file")
parser.add_argument('output_dir', nargs='?', default="semantic_segmentation/output", help="Path to where the final files, will be saved")
